...
import YourComponent1 from '../SongAlbum/songalbum';
import AudioMessage2 from '../MessageFolder/messagefolder';
    ...
    // <Router>
      <Routes>
        <Route path="/Media/AudioMessage" element={<AudioMessage />} />
         <Route path="/Media/MessageFolder" element={<AudioMessage2 />} />
         <Route path="/Media/AudioSongs" element={<AudioSongs />} />
         <Route path="/Media/SongsAlbum" element={<YourComponent1 />} />
